      ...
      child: Card(
        ...
        child: InkWell(
          onTap: () async {
            ...
            String theme =
                await APIs.getTheme(widget.user) ?? 'assets/defaultTheme.png';
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => ChatScreen(
                      user: widget.user, theme: theme, emoji: emoji)),
            );
          },
          child: StreamBuilder(
              ...
              switch (snapshot.connectionState) {
                ...
                case ConnectionState.done:
                  final list = snapshot.data?.docs
                      .map((doc) => MessagesModel.fromJson(
                          doc.data()))
                      .toList();
                  if (list!.isNotEmpty) {
                  ...
                  return ListTile(
                    ...
                    leading: InkWell(
                      onTap: () {
                        showDialog(
                          context: context,
                          builder: (context) =>
                              ProfileDialogScreen(user: widget.user),
                        );
                      },
                      child: ClipRRect(
                    ...
                    trailing: _messages == null
                        ...
                        : _messages!.read.isEmpty &&
                                _messages?.fromid != APIs.users.uid
                            ? Container(
                                width: 10.w,
                                height: 10.h,
